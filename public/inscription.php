...
$stylesheet = Style::getStylesheet('style') . Style::getStylesheet('header-grid') . Style::getStylesheet('style_menu') . Style::getStylesheet('style_form') . Style::getStylesheet('navbar');
